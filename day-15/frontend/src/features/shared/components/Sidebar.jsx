...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        { name: 'Saved', path: '/saved', icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={location.pathname === '/saved' ? "currentColor" : "none"} stroke="currentColor" strokeWidth={location.pathname === '/saved' ? "0" : "2"} strokeLinecap="round" strokeLinejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>
        )},
